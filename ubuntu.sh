...
wget ftp://ftp.csx.cam.ac.uk/pub/software/programming/pcre/pcre-8.42.tar.gz -o pcre-8.42.tar.gz
...
cd
wget http://www.openssl.org/source/openssl-1.1.1b.tar.gz -o openssl-1.1.1b.tar.gz
...
cd
wget https://nginx.org/download/nginx-1.14.2.tar.gz -o nginx-1.14.2.tar.gz
